...
<div class="dashboard-title">
    <div>
        ...
        <p>Tulis pesan yang akan tampil di dashboard setiap penghuni.</p>
    </div>
</div>

<div style="max-width: 800px; margin-top: 2rem;">
    <form action="{{ route('pengumuman.store') }}" method="POST" class="widget" style="padding: 2.5rem;">
        @csrf
        <div style="display: grid; grid-template-columns: 1fr; gap: 1.5rem;">
            <div>
                ...
                <input type="text" name="judul" value="{{ old('judul') }}" placeholder="Contoh: Info Pembayaran Air" style="width: 100%; padding: 0.85rem 1.25rem; border-radius: 12px; border: 1px solid #E2E8F0; outline: none; font-size: 0.95rem;" required>
            ...
            <div>
                ...
                <textarea name="konten" rows="5" placeholder="Tuliskan detail pengumuman di sini..." style="width: 100%; padding: 0.85rem 1.25rem; border-radius: 12px; border: 1px solid #E2E8F0; outline: none; font-size: 0.95rem; resize: vertical;" required>{{ old('konten') }}</textarea>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 1rem;">
                <div>
                    ...
                    <select name="ikon" style="width: 100%; padding: 0.85rem 1rem; border-radius: 12px; border: 1px solid #E2E8F0; outline: none; font-size: 0.9rem; background: white;">
                        <option value="fa-bullhorn" selected>Bullhorn (🔊)</option>
                        <option value="fa-circle-info">Info (ℹ️)</option>
                        <option value="fa-triangle-exclamation">Warning (⚠️)</option>
                        <option value="fa-calendar-days">Event (📅)</option>
                ...
                <div>
                    ...
                    <input type="color" name="warna_bg" value="#EFF6FF" style="width: 100%; height: 45px; border: none; border-radius: 12px; cursor: pointer;">
                </div>
                <div>
                    ...
                    <input type="color" name="warna_ikon" value="#3B82F6" style="width: 100%; height: 45px; border: none; border-radius: 12px; cursor: pointer;">
                </div>
            </div>
